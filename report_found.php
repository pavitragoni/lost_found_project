...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $found_date  = mysqli_real_escape_string($conn, $_POST['found_date']);
    $location    = mysqli_real_escape_string($conn, $_POST['location']);
    $user_id     = $_SESSION['user_id'];

    $sql = "INSERT INTO Found_Item (Item_Name, Description, Found_Date, Location, User_ID)
            VALUES ('$item_name', '$description', '$found_date', '$location', '$user_id')";
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input:focus, textarea:focus { border-color: #38a169; }
...
<div class="card">
    ...
    <form method="POST">
        ...
        <input type="text" name="location" placeholder="e.g. Canteen, Block B" required>
